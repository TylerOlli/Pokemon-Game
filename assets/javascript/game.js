...
$(this).removeClass('ShakeAnimation');
  ...
  var renderCharacters = function(charObj, areaRender) {
    ...
    if (areaRender === "enemyDefeated") {
      $("#defender").empty();
      var gameStateMessage = "You have defeated " + charObj.name + ", fight another enemy.";
  ...
  $(document).on("click", ".character", function() {
    ...
    $( ".jumbotron" ).slideUp();
    $( "#selectpokemon" ).hide();
    $( "#selected-character" ).show( "slow" );
    $( "#available-to-attack-section" ).slideDown( "slow" );
    $( "#fight-section1" ).show();
    $( "#fight-section" ).show();
    $( "#action" ).show();
    $( "#yourpokemon" ).show();
    ...
    if (!currSelectedCharacter) {
      ...
      $("#characters-section").slideUp( "fast" );
